...
cenpop<- read.csv("./data/census/popestimates1317.csv", header = T, sep = ",",stringsAsFactors = F)
head(cenpop)
...
cenpopr<- cenpopr[-2,]
cenpoprr<- read.csv("./data/census/popestimatesr.csv",header = T, sep=",", stringsAsFactors = F)
dim(cenpoprr)
