...
SKBLT_long<- SKBLT %>% 
  ...
  group_by(month) 
  ggplot(aes(x = month, y = ave_rsv ))+geom_boxplot()
...
kruskal.test(ave_rsv ~ month, data = SKBLT_long)
...
```{r}
skbr<- read.csv(file="./data/GtrendData/SkinBleachingRegion0419.csv", header = F, sep = ",", stringsAsFactors = F,col.names = c("Region","RSF"))
skbr
skbr<- skbr[c(-1,-2),]
skbr$RSF<- as.numeric(skbr$RSF)
#head(skbr)

sklr<- read.csv("./data/GtrendData/SkinLighteningRegion0419.csv", header = T, sep = ",", stringsAsFactors = F,col.names = c("Region","RSF"))
sklr<- sklr[-1,]
...
skblr <- skblr %>% 
  mutate(aveRSF = (Bleaching+Lightening)/2) %>% 
  select(Region, aveRSF)

```

```{r}

skblr$aveRSF<- (skblr$Bleaching + skblr$Lightening)/2
...
fit = lm(aveRSF ~ Foreign_born + Internet_subscription +persons_in_poverty+black+hispanic ,  data = sbl_cenpop_row)
...
##### strickly look at 2010-2018


#population
cenpoprr$Population.estimates.base..April.1..2010....V2018.
summary(Population.estimates.base..April.1..2010....V2018.)
cor.test(skblmmp$Population.estimates.base..April.1..2010....V2018., skblmmp$aveRSF)
#p = 0.3342


#Age
cenpoprr$Persons.under.5.years..percent
summary(cenpoprr$Persons.under.5.years..percent)
cor.test(skblmmp$Persons.under.5.years..percent, skblmmp$aveRSF)
#p = 0.03975   cor = -0.35538


cenpoprr$Persons.under.18.years..percent
summary(cenpoprr$Persons.under.18.years..percent)
cor.test(skblmmp$Persons.under.18.years..percent, skblmmp$aveRSF)
#p = 0.4177

cenpoprr$Persons.65.years.and.over..percent
summary(cenpoprr$Persons.65.years.and.over..percent)
cor.test(skblmmp$Persons.65.years.and.over..percent, skblmmp$aveRSF)
#p = 0.8769 cor = -0.028

summary
#Education
cenpoprr$High.school.graduate.or.higher..percent.of.persons.age.25.years...2013.2017
summary(cenpoprr$High.school.graduate.or.higher..percent.of.persons.age.25.years...2013.2017)
cor.test(skblmmp$High.school.graduate.or.higher..percent.of.persons.age.25.years...2013.2017, skblmmp$aveRSF)

cenpoprr$Bachelor.s.degree.or.higher..percent.of.persons.age.25.years...2013.2017
summary(cenpoprr$Bachelor.s.degree.or.higher..percent.of.persons.age.25.years...2013.2017)
cor.test(skblmmp$Bachelor.s.degree.or.higher..percent.of.persons.age.25.years...2013.2017, skblmmp$aveRSF)

summary
#health insurance
cenpoprr$Persons..without.health.insurance..under.age.65.years..percent
summary(cenpoprr$Persons..without.health.insurance..under.age.65.years..percent)
cor.test(skblmmp$Persons..without.health.insurance..under.age.65.years..percent, skblmmp$aveRSF)
